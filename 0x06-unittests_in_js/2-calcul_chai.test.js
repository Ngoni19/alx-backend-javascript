...
describe('calculateNumber', () => {
  ...
  describe('type == "DIVIDE"', () => {
    ...
    it('0 and positive number', () => {
      expect(calculateNumber('DIVIDE', 0.0, 8.0)).to.equal(0);
    });

    it('0 and negative number', () => {
      expect(calculateNumber('DIVIDE', 0.0, -9.0)).to.equal(-0);
    });
    ...
    it('positive number and number rounded down to 0', () => {
      expect(calculateNumber('DIVIDE', 15.0, 0.2)).to.equal('Error');
    });

    it('positive number and number rounded up to 0', () => {
      expect(calculateNumber('DIVIDE', 9.0, -0.5)).to.equal('Error');
    });
    ...
    it('negative number and number rounded down to zero', () => {
      expect(calculateNumber('DIVIDE', -9.0, 0.2)).to.equal('Error');
    });
